...
Anyway, I also recommend to check  [racknotes's 8 step checklist after installing proxmox](https://racknotes.pro/things-to-do-after-installing-proxmox/) as it covers a bit different view from my article here, also including different Operating Systems.
