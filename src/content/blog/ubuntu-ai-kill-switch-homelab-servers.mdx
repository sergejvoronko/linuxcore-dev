---
title: "Ubuntu's AI Kill Switch: Disable Canonical AI Features"
...
- [Linux Homelab Security Hardening: Complete Checklist (2026)](/homelab/linux-security-hardening/): Lock down the rest of the default install, not just the AI components
