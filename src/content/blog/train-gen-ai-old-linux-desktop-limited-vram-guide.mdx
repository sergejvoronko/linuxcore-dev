...
-   [Deploy Your Own Private Docker Registry in Your Homelab](/homelab/private-docker-registry-homelab)
-   [Build a Cost-Effective AWS GPU Instance for AI Experiments](/aws/ec2-gpu-instance-ai-cost-guide)
-   [Self-Host Your Own GitHub Actions Runners with Proxmox](/homelab/self-hosted-github-runners-proxmox)
-   [Building a Serverless API with Astro and AWS Lambda](/astro/serverless-api-astro-lambda)