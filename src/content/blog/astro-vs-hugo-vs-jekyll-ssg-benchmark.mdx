...
<Comparison
  caption="Astro vs Hugo vs Jekyll at a glance"
  options={["Astro", "Hugo", "Jekyll"]}
  rows={[
    { label: "Cold build, 100 pages",  values: ["~8s", "~0.3s", "~6s"], winner: 1 },
    { label: "Cold build, 500 pages",  values: ["~52s", "~1.1s", "~38s"], winner: 1 },
    { label: "Output size, 100 pages", values: ["4.8 MB", "2.1 MB", "3.4 MB"], winner: 1 },
    { label: "Interactive islands / components", values: ["yes", "no", "no"], winner: 0 },
    { label: "Zero JS by default",     values: ["yes", "yes", "yes"] },
    { label: "Scales past 500+ pages", values: ["no", "yes", "no"], winner: 1 },
    { label: "GitHub Pages native",    values: ["no", "no", "yes"], winner: 2 },
    { label: "Language",               values: ["JS / TS", "Go templates", "Ruby / Liquid"] },
  ]}
/>
