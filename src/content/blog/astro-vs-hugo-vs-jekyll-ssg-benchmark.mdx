...
- [Deploy a Hugo site to Cloudflare Pages with automatic builds](/astro/astro-github-cloudflare-stack)
- Self-host your site behind a Cloudflare Tunnel on Proxmox
- Astro Content Collections for a homelab documentation site
- [MinIO object storage on a homelab NAS for static site backups](/homelab/stratis-storage-homelab-guide)