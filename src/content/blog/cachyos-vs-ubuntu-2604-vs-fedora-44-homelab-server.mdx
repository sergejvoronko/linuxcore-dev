...
- [/homelab/podman-quadlets-systemd-homelab-services](/homelab/podman-rootless-copy-fail-exploit-homelab-security) — Replace Docker Compose with Podman Quadlets for proper systemd-managed containers
- [/homelab/k3s-homelab-cluster-setup](/homelab/k3s-kubernetes-homelab) — Running a lightweight Kubernetes cluster on homelab hardware
- [/homelab/btrfs-vs-zfs-homelab-nas](/homelab/stratis-storage-homelab-guide) — Filesystem choice for your homelab NAS: Btrfs vs ZFS in 2026
- [/aws/self-hosted-vs-aws-homelab-cost-comparison](/aws/when-to-move-homelab-to-aws) — When it actually makes sense to move homelab workloads to AWS