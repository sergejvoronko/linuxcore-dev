...
- [/homelab/proxmox-ve-hardening-guide](/homelab/proxmox-homelab-setup) — Lock down your Proxmox host properly after this patch scare
- [/homelab/rootless-docker-podman-homelab](/homelab/podman-rootless-copy-fail-exploit-homelab-security) — Understanding rootless containers and when they actually matter for security
- [/homelab/kernel-live-patching-ubuntu-proxmox](/homelab/proxmox-homelab-setup) — Apply kernel patches without rebooting using kpatch or livepatch
