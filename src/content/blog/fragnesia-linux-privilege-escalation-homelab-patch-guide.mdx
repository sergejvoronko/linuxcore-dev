---
title: "Fragnesia: Check and Patch This Linux LPE on Your Homelab"
description: "Fragnesia is a Linux kernel LPE exploit hitting homelabs. How to check your kernel, patch via apt/dnf/pacman, and apply stopgap mitigations on Proxmox."
pubDate: 2026-05-14
readingTime: 8
...
Proxmox packages its kernel separately. The `pveversion` output will show your kernel package version, cross-reference with the [Proxmox VE announcements forum](https://forum.proxmox.com/forums/proxmox-ve-announcements.16/).
...
- [Mitigating 400+ Linux Kernel CVEs in Your Homelab](/homelab/linux-kernel-cves-homelab-patching-guide/): Turn this one-off patch into a repeatable triage and update routine
- [MicroVMs in Proxmox: True Homelab Isolation, Simply](/homelab/microvms-proxmox-ve-homelab-isolation/): Defence in depth, limit the blast radius of any local exploit with real isolation