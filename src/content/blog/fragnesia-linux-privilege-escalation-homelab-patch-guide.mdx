...
- [/homelab/proxmox-ve-hardening-guide](/homelab/proxmox-ve-hardening-guide) — Lock down your Proxmox host properly after this patch scare
- [/homelab/rootless-docker-podman-homelab](/homelab/rootless-docker-podman-homelab) — Understanding rootless containers and when they actually matter for security
- [/homelab/kernel-live-patching-ubuntu-proxmox](/homelab/kernel-live-patching-ubuntu-proxmox) — Apply kernel patches without rebooting using kpatch or livepatch
- [/homelab/homelab-network-segmentation-vlans](/homelab/homelab-network-segmentation-vlans) — Defense in depth: limit blast radius from any local exploit with proper network segmentation