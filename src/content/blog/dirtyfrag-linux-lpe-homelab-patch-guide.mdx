...
- [/homelab/proxmox-hardening-guide](/homelab/proxmox-hardening-guide) — Lock down your Proxmox VE host before the next exploit drops
- [/homelab/ansible-homelab-automation](/homelab/ansible-homelab-automation) — Build a full Ansible setup for managing your homelab fleet
- [/homelab/unattended-upgrades-debian-ubuntu](/homelab/unattended-upgrades-debian-ubuntu) — Automate security patching so you are never caught behind on a critical CVE
- [/homelab/lxc-unprivileged-containers-proxmox](/homelab/lxc-unprivileged-containers-proxmox) — Migrate to unprivileged LXC containers and reduce kernel attack surface