---
title: "SEO in Astro Without Plugins: Sitemaps and Schema"
...
Once the SEO layer is in place, the rest of this site is built from the same
no-plugin approach:

- [Giscus comments](/astro/astro-giscus-comments/), GitHub Discussions as a comment backend, no database
- [A Clerk and Stripe paywall on Cloudflare](/astro/astro-cloudflare-clerk-stripe-paywall/), for gating premium posts without a server
- [Astro 6.1.10's server island fix](/astro/astro-6-1-10-server-island-security-hardening/), worth reading before you ship SSR routes
- [Astro 7.0 alpha and the Vite v8 upgrade](/astro/astro-7-alpha-vite-v8-upgrade-what-to-expect/), what breaks when you move off 6.x

If you are still choosing a framework, the [Next.js to Astro 5 migration](/astro/nextjs-to-astro-5-migration-homelab-cost-performance/)
and [SvelteKit vs Astro benchmarks](/astro/sveltekit-vs-astro-performance-benchmark-real-world/)
have the numbers behind that decision.
