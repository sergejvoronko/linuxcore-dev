...
- [Self-Hosting on a Static IP: The No-Nonsense Homelab Guide](/homelab/self-host-static-ip-living-room-homelab/): Getting a routable address to your box so the Git server is reachable
- [Coolify on Your Homelab: Ditch Vercel and Heroku for Good](/homelab/coolify-self-hosted-paas-homelab-proxmox-setup/): Traefik-based routing and TLS in front of your Docker stack
