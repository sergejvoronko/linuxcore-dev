...
- [/astro/astro-cloudflare-pages-deployment-guide](/astro/astro-github-cloudflare-stack) — Full walkthrough for deploying Astro to Cloudflare Pages with the official adapter
- /astro/astro-mdx-setup-and-optimization — How to configure the MDX integration for performance-sensitive Astro sites
- [/homelab/self-hosted-ci-cd-with-woodpecker](/homelab/forgejo-self-hosted-git-homelab-docker) — Run your own CI pipeline so you control when and how upgrades land
