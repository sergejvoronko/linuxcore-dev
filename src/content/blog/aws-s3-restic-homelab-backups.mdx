...
If you're running Prometheus and Grafana (and if you followed the [homelab monitoring guide](/homelab/grafana-prometheus-homelab), you are), expose this as a textfile collector metric:
...
- The [Ansible homelab automation guide](/homelab/ansible-homelab) can deploy this entire backup pipeline across multiple machines with a single playbook
