...
<Comparison
  caption="Debian Trixie vs Ubuntu 24.04 LTS for homelab"
  options={["Debian Trixie", "Ubuntu 24.04 LTS"]}
  rows={[
    { label: "Support window",        values: ["~5 years", "5 yr LTS / 10 w/ Pro"] },
    { label: "Baseline RAM (minimal)", values: ["Lower", "Higher"], winner: 0 },
    { label: "Newer mainline kernel",  values: ["no", "yes"], winner: 1 },
    { label: "No Snap / cloud-init",   values: ["yes", "no"], winner: 0 },
    { label: "Predictable / no surprises", values: ["yes", "no"], winner: 0 },
    { label: "Ecosystem & docs coverage", values: ["Large", "Larger"], winner: 1 },
    { label: "MicroK8s / Snap store",   values: ["no", "yes"], winner: 1 },
    { label: "Best for NAS / DNS / app server", values: ["yes", "yes"] },
  ]}
/>
