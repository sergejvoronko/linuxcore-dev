...
description: "Deploy Coolify on Proxmox or bare-metal Linux, set up push-to-deploy, and route traffic with Caddy or Traefik. Self-hosted PaaS that actually works."
pubDate: 2026-05-18
readingTime: 8
...
Two things it does not solve, and both bite once you start hosting for real: getting a routable address to your box, covered in [self-hosting behind a static IP](/homelab/self-host-static-ip-living-room-homelab/), and outbound email, covered in [running your own mail server](/homelab/self-host-mail-server-homelab-guide-2026/).
...
- Running Nginx Proxy Manager on Proxmox for Homelab Routing
- [Proxmox VM vs LXC: When to Use Each for Homelab Services](/homelab/proxmox-homelab-setup/)
- Cloudflare Tunnels for Homelab: Expose Services Without Port Forwarding
- [Self-Hosting Gitea on Docker: Your Own GitHub at Home](/homelab/forgejo-self-hosted-git-homelab-docker/)