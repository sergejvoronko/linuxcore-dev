---
title: "Stratis on Linux: ZFS-Like Storage, Less Complexity"
...
NAS drives I trust for homelab storage (affiliate links. They help fund the site at no extra cost to you):

- [WD Red Plus 4TB NAS HDD](/go/wd-red-plus-4tb/)
- [Seagate IronWolf 4TB NAS HDD](/go/seagate-ironwolf/)
- [Synology DS224+ NAS](/go/synology-ds224/): if you want a turnkey enclosure

## What's Next

- [Proxmox VE Homelab Setup](/homelab/proxmox-homelab-setup/): set up the host your storage VMs run on
- [Grafana + Prometheus Monitoring](/homelab/grafana-prometheus-homelab/): alert on pool capacity and disk health
- [Linux Homelab Security Hardening: Complete Checklist (2026)](/homelab/linux-security-hardening/): Encryption at rest and the rest of the storage-host baseline