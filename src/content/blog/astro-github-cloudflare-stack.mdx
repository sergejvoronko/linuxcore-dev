---
title: "Astro + Cloudflare vs WordPress: €12/Year, Faster Site"
...
- [Adding GitHub-based comments](/astro/astro-giscus-comments/) with Giscus, zero external dependencies, free
- [Contact forms](/astro/astro-cloudflare-contact-form/) with Cloudflare Pages Functions and MailChannels
- [Building a shop](/astro/astro-printify-stripe-shop/) with Printify and Stripe in Astro
- [SEO in Astro without plugins](/astro/astro-seo-without-plugins/): sitemaps, structured data, and OG images from scratch
- [Newsletter integration](/astro/astro-newsletter-mailerlite/) with MailerLite
- [Gating premium content](/astro/astro-cloudflare-clerk-stripe-paywall/) with Clerk and Stripe, still no backend server
...
The same stack stretches further than a blog. [A self-hosted game wiki](/astro/astro-game-wiki-self-hosted-guide/) is the content-heavy version of it, and [in-browser HLS playback](/astro/astro-hls-playback-static-site-no-media-proxy/) pushes it about as far as a static site goes, streaming homelab IPTV and camera feeds with no media proxy behind it.
