...
- **[Docker Compose Mega-Stack](/homelab/docker-compose-mega-stack)** — a complete multi-service homelab stack you can deploy in one go
- **[Self-Hosted Google Photos with Immich](/homelab/immich-self-hosted-google-photos)** — full Immich deployment guide with GPU acceleration and backup strategies
- **[Monitoring with Grafana & Prometheus](/homelab/grafana-prometheus-monitoring-stack)** — observe everything running on your server
- **[Linux Security Hardening](/homelab/linux-security-hardening)** — lock down the host your containers run on
- **[Automate Everything with Ansible](/homelab/ansible-homelab-automation)** — deploy Docker and your entire stack configuration automatically
