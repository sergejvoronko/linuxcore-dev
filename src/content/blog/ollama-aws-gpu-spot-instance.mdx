...
If you're running [Open WebUI locally](/homelab/ollama-linux-setup), you can point it at the remote Ollama instance temporarily:
...
- [Ollama + Open WebUI on your homelab](/homelab/ollama-linux-setup) — the local setup that this extends
